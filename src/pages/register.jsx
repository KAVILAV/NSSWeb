...
function Register() {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post('http://localhost:27000/admin/signup', article)
    ...
    <>
     {/*  <form onSubmit={handleSubmit} id="suggestion">
        ...
        <div className="form-group">
          ...
          <input
            type="text" className="form-control" id="adminRoll" value={adminRoll} onChange={(e) => setadminRoll(e.target.value)}
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            type="text" className="form-control" id="adminName" value={adminName} onChange={(e) => setadminName(e.target.value)}
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            type="text" className="form-control" id="adminMail" value={adminMail} onChange={(e) => setadminMail(e.target.value)}
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            type="password" className="form-control" id="adminPassword" value={adminPassword} onChange={(e) => setadminPassword(e.target.value)}
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            type="password" className="form-control" id="adminCPassword" value={adminCPassword} onChange={(e) => setadminCPassword(e.target.value)}
          />
        </div>
